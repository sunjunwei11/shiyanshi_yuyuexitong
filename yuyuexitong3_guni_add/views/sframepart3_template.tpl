	...
	<body style="padding:0px;background:#EAEEF5;">
		...
		<div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; ">
			<div position="left" title="菜单列表" id="accordion1" >
				<div title="个人信息" class="l-scroll">
                    <a class="l-link" href="javascript:f_addTab('listpage','密码修改','/password')">密码修改</a> 
				</div>
				<div title="讨论组" class="l-scroll">

				</div>
				<div title="问卷调查" class="l-scroll">
					<a class="l-link" href="javascript:f_addTab('questions','问卷调查','/questionnaire')">问卷调查（实验前）</a>
					<a class="l-link" href="javascript:f_addTab('questions1','问卷调查','/questionnaire1')">问卷调查（实验后）</a>
				</div>
				<div title="成绩查询" class="l-scroll">
