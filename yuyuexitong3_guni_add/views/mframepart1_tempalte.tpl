	...
	<body style="padding:0px;background:#EAEEF5;">
		...
		<div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; ">
			<div position="left" title="菜单列表" id="accordion1" >
				<div title="学生信息录入" class="l-scroll">
					<a class="l-link" href="javascript:f_addTab('sfrominput','学生信息录入','sfrominput')">学生信息录入</a> 
					 
				</div>
				<div title="老师信息录入" class="l-scroll">
					
				</div>
				<div title="管理员信息录入" class="l-scroll">
