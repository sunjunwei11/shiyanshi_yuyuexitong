              ...
              $.each(value,function(indec,items){
                 ...
                 $.each(items,function(key,value){
                      ...
                      var en=bb[7];
                        ...
                        var en1=parseInt(en.substring(0,4)+en.substring(5,7)+en.substring(8,10));
                        var st1=parseInt(st.substring(0,4)+st.substring(5,7)+st.substring(8,10))
                     ...
                     //alert(m);
                      ...
                      day1=day+d;
                        if(day1<10)
	                       cc[4]=yearStr+"-"+monthStr+"-"+(day>=10?day:("0"+day1));
	                    else
	                       cc[4]=yearStr+"-"+monthStr+"-"+(day>=10?day:(day1));
	                    dd[d]=cc[4];   //实验日期列表
