		...
		<header>
			<div id="headerWrapper">
				<div id="headerCenter">
					...
					<nav>
						<a id="group0"> <img src="img/icons/home.png" alt="Home"/>信息录入 </a>
						<a id="group1"> <img src="img/icons/download_s.png" alt="Download"/>实验管理 </a>
						<a id="group2"> <img src="img/icons/questionmark.png" alt="Support"/>用户管理</a>
					</nav>
					<div>
		...
		<div id="wrapper">
			<div id="centerWrapper">
				<div id="tileContainer">
					...
					<a href="#&amp;home" id="groupTitle0" class="groupTitle" style="margin-left:0px; margin-top:0px" onclick="javascript:$group.goTo(0);"><h3>信息录入</h3></a>
					<a href="#&amp;download" id="groupTitle1" class="groupTitle" style="margin-left:775px; margin-top:0px" onclick="javascript:$group.goTo(1);"><h3>实验管理</h3></a>
					<a href="#&amp;support" id="groupTitle2" class="groupTitle" style="margin-left:1550px; margin-top:0px" onclick="javascript:$group.goTo(2);"><h3>用户管理</h3></a>
					<a  href="/mframepart1" class="tile tileCenteredSlide left group0 " style="
					margin-top:45px; margin-left:0px;
					width:300px; height:145px;
					background:rgb(80, 150, 1);"  data-pos='45-0-300' 	>
					<div class="container1">
						<h3 style="background-image: img/features/jiqiren.png'">学生信息录入</h3>
					</div>
					<div class="container2">
						<img src='img/features/xuexi1.png' alt='' />
					</div> </a>
					<a  href='/mframepart1' id="tileSlideshow0-2-0" class="tile tileSlideshow group0 " style="
					...
					<a  href='/mframepart1' class="tile tileFlipText vertical group0 " style="
					...
					<div class='flipContainer'>
						<div class='flipFront' style="background:#FF8000;">
							...
							src='img/icons/pen.png' height="60" width="60"/>老师与管理员信息录入</h3>
						</div>
					...
					<a  href='/mframepart1' class="tile tileSlideFx group0 " style="
					...
					<a  href='/mframepart2' class="tile tileCentered group1 " style="
					...
					>
						...
						src='img/icons/box_download.png' height="60" width="60"/>实验课程管理</h3>

					</div> </a>
					<a  href='/mframepart2' class="tile tileSlide up group1 " style="
					...
					>
						...
						><img title='' alt='' style='margin-top:0px;margin-left:0px;'
						src='img/icons/box_download_blue.png' height="60" width="60"/> 实验设备管理 </h3>

					</div> </a>
					<a  href='/mframepart2' id="tileScroll1_2-1" class="tile tileScroll group1 " style="
					margin-top:200px; margin-left:1085px;
					width:145px; height:145px;
					background:#11528F;"  data-pos='200-1085-145' >
					<div class='tileTitle' style='margin-left:10px;'>
						<span style='font-size:24px;'>实验课程管理</span>
					</div>
					...
					<a href='/mframepart2' class="tile tileImg group1 bottom endGroup" style="
					...
					<div class='tileLabelWrapper bottom'>
						<div class='tileLabel bottom' style='border-bottom-color:#FFF;'>
							<span style='color:#11528f;'>综合查询</span>
						</div>
						<div class='imgDesc' style='display:none;'>
							综合查询
						</div>
					</div> </a>
					<a  href='/mframepart3' class="tile group2 align-center" style="
					...
					<a  href='/mframepart3' class="tile tileFlip horizontal group2 " style="
					...
					<div class='flipContainer'>
						...
						<div class='flipBack' style="background:#c82345;">
							<h5><span style='font-size:22px;'>密码管理</span></h5>
						</div>
					...
					<div class='flipContainer'>
						...
						<div class='flipBack' style="background:#dea317;">
							<h5><span style='font-size:22px;'>公告管理</span></h5>
						</div>
