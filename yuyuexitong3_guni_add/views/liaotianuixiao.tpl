...
#all {
	...
	top:20px;
	left:50px;
	background-image:url(../../img/whut2_xiao.png);
	}
#top {
	width:500px;
	height:70px;
...
<div id = "all">
     <div id = "top">
         <p style = "text-align:center; font-size:20px; color:#383467; margin:0px; padding:6px; text-shadow:4px 0px 4px #FFFFFF;font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif">自动化实验室</p>
         <p id="fubiaoti" style= "text-align:center;font-size:12px;margin:0px; padding:0px,0px,0px,0px;color:#383467; text-shadow:2px 0px 2px #FFFFFF;">{{taolunzu_name}}</p>
