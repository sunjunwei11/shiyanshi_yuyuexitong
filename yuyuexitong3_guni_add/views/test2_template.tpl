				...
				<div id="headerCenter">
					...
					<div>
						<table height="150" width="100%" border="1" bordercolor="#FFF">
							<tbody>
								<tr>
									<td id="chart" style="background-position: center; background-repeat: no-repeat" align="left" ><font color="#F03" style="font-size:16px; position:relative;top:0%;right:3%;   font-family:'楷体'">
										<p  align="right">
											<b>工号:{{user["userid"]}}</b>
										</p></font><font color="#F03" style="font-size:16px; position:relative;top:2%;right:3%;  font-family:'楷体'">
										<p align="right">
											<b>姓名:{{user["username"]}}</b>
										</p></font><font color="#F03" style="font-size:16px; position:relative;top:4%;right:3%; font-family:'楷体'">
										<p align="right">
											<b>权限:{{user["authority"]}}</b></p>
									</font>
									<font color="#F03" style="font-size:16px; position:relative;top:4%;right:3%; font-family:'楷体'">
									    <p align="right">
