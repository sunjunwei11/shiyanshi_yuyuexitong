...
.start{width:300px;height:50px;border-radius:45px;-moz-border-radius:45px;background-color:#227700;font-size:20px;}
.done{width:300px;height:50px;border-radius:45px;-moz-border-radius:45px;background-color:#227700;display:none;font-size:20px;}
...
$('#anwser10').val("");
 ...
 $.ajax({
					...
					success : function(data) {
						...
						if (data["msg"] == 0) {
						    $("#title").hide();
							$("#start").replaceWith("<p><b>你已完成问卷调查（实验前）！</b></p>");
						}
					}
				})
  $.ajax({
...
<body>
    <div id=header><img class="img" src="/images/questionnaire/question5.jpg"/></div>
