...
if (!((window._atc || {}).ver)) {
	var _atd = "www.addthis.com/", _atr = window.addthis_cdn || "//s7.addthis.com/", _euc = encodeURIComponent, _duc = decodeURIComponent, _atc = {
		...
		rsrcs : {
			...
			core : _atr + "static/r07/core131.js",
			...
			layersjs : _atr + "static/r07/layers049.js",
			layerscss : _atr + "static/r07/layers040.css",
			...
			widget32css : _atr + "static/r07/widgetbig060.css",
			widget32whitecss : _atr + "widgetbigwhite.css",
			widget20css : _atr + "static/r07/widgetmed010.css",
			widgetcss : _atr + "static/r07/widget120.css",
			widgetIE67css : _atr + "static/r07/widgetIE67006.css",
			widgetpng : "//s7.addthis.com/static/r07/widget060.gif",
			...
			pinit : _atr + "static/r07/pinit018.html",
			linkedin : _atr + "static/r07/linkedin023.html",
			fbshare : _atr + "static/r07/fbshare004.html",
			tweet : _atr + "static/r07/tweet028.html",
			menujs : _atr + "static/r07/menu163.js",
			sh : _atr + "static/r07/sh159.html"
		}
	};
}(function() {
	var i, q = window, C = document;
	var s = (window.location.protocol == "https:"), F, n, y, A = (navigator.userAgent || "unk").toLowerCase(), v = (/firefox/.test(A)), p = (/msie/.test(A) && !(/opera/.test(A))), c = {
		0 : _atr,
		1 : "//ct1.addthis.com/",
		6 : "//ct6z.addthis.com/"
	}, g = {
	...
	if (!window.addthis || window.addthis.nodeType !== i) {
		...
		if (document.location.href.indexOf(_atr) == -1) {
			...
			if (!t.firstChild) {
				var l, A = navigator.userAgent.toLowerCase(), u = Math.floor(Math.random() * 1000);
		...
		setTimeout(function() {
			if (!window.addthis.timer.core) {
				...
				if (_atc.cdn !== 0) {
					var d = document.createElement("script");
					d.type = "text/javascript";
					d.src = ( s ? "https:" : "http:") + _atr + "static/r07/core131.js";
					h.appendChild(d);
				}
			}
		}, m);
